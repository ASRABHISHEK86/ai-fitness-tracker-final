    ...
    return (
        <div className="bg-gray-800/50 p-6 rounded-2xl border border-gray-700 shadow-xl">
            ...
            <form onSubmit={handleMealSubmit}>
                <input type="text" value={mealInput} onChange={(e) => setMealInput(e.target.value)} placeholder="e.g., 1 bowl of oatmeal with berries"
                ...
                <button type="submit" disabled={isLoading} className="w-full mt-4 p-3 font-bold text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-md hover:opacity-90 disabled:opacity-50">
